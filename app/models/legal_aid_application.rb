class LegalAidApplication < ApplicationRecord
  ...
  has_one :legal_framework_merits_task_lists, -> { order(created_at: :asc) }, class_name: 'LegalFramework::MeritsTaskList', inverse_of: :legal_aid_application, dependent: :destroy
